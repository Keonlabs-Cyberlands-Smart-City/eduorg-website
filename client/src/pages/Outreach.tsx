        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-blue-50 p-6 rounded-lg text-center">
              ...
              <p className="text-gray-600">Outreach Programs / Year</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg text-center">
              <h3 className="text-4xl font-bold text-blue-600">{stats.members}</h3>
              <p className="text-gray-600">Community Members Reached</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg text-center">
              <h3 className="text-4xl font-bold text-blue-600">{stats.communities}</h3>
              <p className="text-gray-600">Communities Served</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg text-center">
              <h3 className="text-4xl font-bold text-blue-600">{stats.volunteers}</h3>
