...
export default function Outreach() {
  const stats = [
    { number: "6", label: "Outreach Programs / Year" },
  ...
  const updates = [
    { title: "Community Training", desc: "Skills development for adults.", img: "https://images.unsplash.com/photo-1521791136064-7986c2920216" },
    { title: "Health Awareness", desc: "Health and wellness seminars.", img: "https://images.unsplash.com/photo-1552664730-d307ca884978" },
    { title: "Livelihood Programs", desc: "Income generation initiatives.", img: "https://images.unsplash.com/photo-1552664730-d307ca884978" },
  ];
    ...
    <div className="min-h-screen flex flex-col bg-gray-100 font-sans">
      ...
      <section id="overview" className="py-12 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-8">Outreach Statistics</h2>
      ...
      <section id="gallery" className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold mb-6 text-center">Outreach Gallery</h2>
