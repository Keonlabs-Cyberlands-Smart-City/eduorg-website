    ...
    <div className="min-h-screen flex flex-col bg-white font-sans">
      ...
      >
        ...
        <div className="relative z-10 bg-black/40 backdrop-blur-sm p-12 rounded-2xl text-center animate-fade-in-up max-w-2xl">
          ...
          <p className="text-xl text-gray-100">ICT, literacy and social clubs for student growth</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 text-lg">Fostering innovation and creativity through diverse clubs</p>
          
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { label: "Active Clubs", value: stats.clubs, color: "#e57d06" },
              { label: "Club Members", value: stats.members, color: "#95ba12" },
              { label: "Activities / Year", value: stats.activities, color: "#e57d06" },
              { label: "Participants", value: stats.participants, color: "#95ba12" },
            ].map((stat, idx) => (
              <ScrollReveal
                key={idx}
                animation="fade-up"
      ...
      <section className="py-16 text-white" style={{ backgroundColor: '#95ba12' }}>
        <div className="max-w-4xl mx-auto px-4 text-center animate-fade-in-up">
          ...
          <p className="text-lg mb-8 text-gray-100">Explore your interests and connect with like-minded students</p>
          <button
