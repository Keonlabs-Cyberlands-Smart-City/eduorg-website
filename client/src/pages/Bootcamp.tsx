    ...
    <div className="min-h-screen flex flex-col bg-white font-sans">
      ...
      >
        ...
        <div className="relative z-10 bg-black/40 backdrop-blur-sm p-12 rounded-2xl text-center animate-fade-in-up max-w-2xl">
          ...
          <p className="text-xl text-gray-100">Academic intensive programs for student excellence</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 text-lg">Empowering students through intensive academic programs</p>
          
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { label: "Bootcamps / Year", value: stats.bootcamps, color: "#e57d06" },
      ...
      <section className="py-16 text-white" style={{ backgroundColor: '#95ba12' }}>
        <div className="max-w-4xl mx-auto px-4 text-center animate-fade-in-up">
          <h3 className="text-3xl font-bold mb-4">Ready to Join Our Bootcamp?</h3>
          <p className="text-lg mb-8 text-gray-100">Transform your academic journey with our intensive programs</p>
          <button
