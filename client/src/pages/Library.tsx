...
export default function Library() {
  ...
  const gallery = [
    "https://d2xsxph8kpxj0f.cloudfront.net/310519663455556448/epjCjfnCCf8LFtGtGELo3e/Library image_54c70572.jpg",
    "https://d2xsxph8kpxj0f.cloudfront.net/310519663455556448/epjCjfnCCf8LFtGtGELo3e/Library image_54c70572.jpg",
    "https://d2xsxph8kpxj0f.cloudfront.net/310519663455556448/epjCjfnCCf8LFtGtGELo3e/Library image_54c70572.jpg",
  ];
    ...
    <div className="min-h-screen flex flex-col bg-gray-100 font-sans">
      ...
      >
        <div className="bg-black/60 p-8 rounded-xl text-center">
          ...
          <p>Books and resources for student learning</p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-blue-50 p-6 rounded-lg text-center">
              <h3 className="text-4xl font-bold text-blue-600">{stats.books}</h3>
              <p className="text-gray-600">Books Available</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg text-center">
              <h3 className="text-4xl font-bold text-blue-600">{stats.readers}</h3>
            ...
            <div className="bg-blue-50 p-6 rounded-lg text-center">
              <h3 className="text-4xl font-bold text-blue-600">{stats.programs}</h3>
              <p className="text-gray-600">Reading Programs</p>
            </div>
          </div>
        </div>
      </section>
