...
export default function Library() {
  ...
  const loadStats = async () => {
    try {
      const docRef = doc(db, "statistics", "library");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white font-sans">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://d2xsxph8kpxj0f.cloudfront.net/310519663455556448/epjCjfnCCf8LFtGtGELo3e/Library image_54c70572.jpg')",
        }}
      >
        ...
        <div className="relative z-10 bg-black/40 backdrop-blur-sm p-12 rounded-2xl text-center animate-fade-in-up max-w-2xl">
          ...
          <p className="text-xl text-gray-100">Books, resources, and knowledge for lifelong learning</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 text-lg">Empowering minds through access to knowledge and resources</p>
          
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { label: "Books Available", value: stats.books, color: "#e57d06" },
              { label: "Active Readers", value: stats.readers, color: "#95ba12" },
              { label: "Schools Served", value: stats.schools, color: "#e57d06" },
              { label: "Programs Offered", value: stats.programs, color: "#95ba12" },
            ].map((stat, idx) => (
              <div
                key={idx}
      ...
      <section className="py-16 text-white" style={{ backgroundColor: '#e57d06' }}>
        <div className="max-w-4xl mx-auto px-4 text-center animate-fade-in-up">
          <h3 className="text-3xl font-bold mb-4">Explore Our Library</h3>
          <p className="text-lg mb-8 text-gray-100">Discover a world of knowledge and endless learning opportunities</p>
          <button
